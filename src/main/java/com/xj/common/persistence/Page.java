...
package com.xj.common.persistence;
...
//		this.pageSize = pageSize;
	...
	public String toString() {
		...
		sb.append("<input type=\"text\" value=\""+pageNo+"\" onkeypress=\"var r=/^\\d+$/;if(!r.test(this.value)){this.value="+pageNo+";return false;} var e=window.event||event;var c=e.keyCode||e.which;if(c==13)");
		sb.append(funcName+"(this.value,"+pageSize+",'"+funcParam+"');\" onclick=\"this.select();\"/>页，每页");
		sb.append("<input type=\"text\" value=\""+pageSize+"\" onkeypress=\"var r=/^\\d+$/;if(!r.test(this.value)){this.value="+pageSize+";return false;} var e=window.event||event;var c=e.keyCode||e.which;if(c==13)");
...
//	}
	...
	public void setPageSize(int pageSize) {
		this.pageSize = pageSize <= 0 ? 10 : (pageSize > 200 ? 200 : pageSize);
	}
