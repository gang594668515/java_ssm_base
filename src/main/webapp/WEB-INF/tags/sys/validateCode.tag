...
<%@ attribute name="buttonText" type="java.lang.String" required="false" description="看不清按钮文本"%>
...
<a href="javascript:" onclick="$('.${name}').attr('src','${pageContext.request.contextPath}/servlet/validateCodeServlet?'+new Date().getTime());" class="mid ${name}Refresh" style="${buttonCssStyle}">${buttonText}</a>