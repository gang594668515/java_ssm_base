...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/role/form?id=${role.id}">角色<shiro:hasPermission name="sys:role:edit">${not empty role.id?'修改':'添加'}</shiro:hasPermission>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<form:input path="enname" htmlEscape="false" maxlength="50" class="required" readonly="${empty role.id?'false':'true'}" />
				<span class="help-inline"><font color="red">*</font> 角色英文标识（保存后不允许修改）</span>
			</div>
		</div>
		<div class="control-group">
