...
<script type="text/javascript">
		...
		$(document).ready(function(){
			userTree = $.fn.zTree.init($("#userTree"), setting, allUserNodes);
		...
		var selectedNodes = [
   		        ...
   		        {id:"${user.id}",
   		         pId:"0",
   		         name:"<font color='red' style='font-weight:bold;'>${user.loginName} （${user.name}）</font>"},
   		        </c:forEach>];
		
		var pre_ids = "${selectIds}".split(",");
		var ids=pre_ids.slice(0);
...
<body>
	<div id="assignRole" class="row-fluid">
		<div class="span6" style="margin-top: 8px; padding-left: 16px;">
			<p>待选人员：</p>
			<div id="userTree" class="ztree"></div>
		</div>
		<div class="span6" style="margin-top: 8px; padding-left: 16px; border-left: 1px solid #A8A8A8;">
			<p>已选人员：</p>
